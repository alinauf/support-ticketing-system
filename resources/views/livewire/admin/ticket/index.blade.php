    ...
    <div>
        ...
        <dl class="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-3">
            <div class="overflow-hidden rounded-lg bg-white px-4 py-5 shadow sm:p-6">
                <dt class="truncate text-sm font-medium text-gray-500">Open Tickets</dt>
                <dd class="mt-1 text-3xl font-semibold tracking-tight text-gray-900">
                    {{number_format($openTicketsCount)}}
                </dd>
            </div>

            <div class="overflow-hidden rounded-lg bg-white px-4 py-5 shadow sm:p-6">
                <dt class="truncate text-sm font-medium text-gray-500">Resolved Tickets</dt>
                <dd class="mt-1 text-3xl font-semibold tracking-tight text-gray-900">
                    {{number_format($resolvedTicketsCount)}}
                </dd>
            </div>
                        ...
                        @foreach($tickets as $ticket)
                            ...
                            <tr>
                                ...
                                <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                                    <a href="{{url("tickets/$ticket->id")}}" class="text-teal-600 hover:text-teal-900">View<span
